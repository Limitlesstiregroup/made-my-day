...
const PLACEHOLDER_TOKENS = new Set(['changeme', 'change-me', 'replace-me', 'replace_this', 'placeholder', 'example', 'sample', 'dummy', 'test', 'todo', 'tbd', 'tba', 'unknown', 'default', 'password', 'unset', 'notset', 'null', 'none']);
