...
- Mutation rate-limit telemetry is emitted in both RFC 9333 (`RateLimit-*`) and legacy (`X-RateLimit-*`) headers for safer proxy/client interoperability during GA rollouts
