...
- Incoming `Host` header hardening: duplicate `Host` headers are rejected with HTTP 400, and malformed/control-char/oversized or delimiter-smuggled host headers are rejected with HTTP 421 before routing
