...
- Fetch-metadata duplication hardening: duplicate raw `Sec-Fetch-Site` header lines are rejected with HTTP 400 (`invalid sec-fetch-site header`) before route handling to prevent intermediary/header-fold ambiguity in request-context attribution
