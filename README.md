...
- Operational health details endpoint for runbook triage (`GET /api/health/details`)
...
- `GET /api/health/details` (operational totals + import/winner automation snapshot for GA runbooks)
- `GET /api/stories`
- `POST /api/stories`
